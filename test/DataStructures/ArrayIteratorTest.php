...
class ArrayIteratorTest extends \PHPUnit_Framework_TestCase {
	...
	function testEverySome()
	{
		...
		$this->assertFalse($iterator->every(function ($val) {
			return $val === null;
		}));
	}
	...
	function testEvery()
	{
		...
		$this->assertTrue($iterator->every(function ($val) {
			return $val === null;
		}));
	}
	...
	function testLimit()
	{
		...
		$this->assertInstanceOf(
			'DataStructures\\Iterator\\LimitingIterator',
			$iterator->limit(0)
		);
	}
	...
	{
		$iterator = new ArrayIterator([]);
		$this->assertNull($iterator->max(function () {
			return 1;
		}));
	}
	...
	{
		$iterator = new ArrayIterator([]);
		$this->assertNull($iterator->min(function () {
			return 1;
		}));
	}
	...
	function testMap()
	{
		$iterator = new ArrayIterator([0]);
		$this->assertInstanceOf(
			'DataStructures\\Iterator\\MappingIterator',
	...
	function testSlice()
	{
		...
		$this->assertInstanceOf('DataStructures\\Iterator\\SlicingIterator', $slicer);
	}
	...
	function testSkip()
	{
		$iterator = new ArrayIterator([0]);
		$this->assertInstanceOf(
			'DataStructures\\Iterator\\SkippingIterator',
			$iterator->skip(0)
		);
	}
	...
	function testFilter()
	{
		$iterator = new ArrayIterator([0]);
		$this->assertInstanceOf(
			'DataStructures\\Iterator\\FilteringIterator',
