...
class HashingMediatorTest extends \PHPUnit_Framework_TestCase {
	...
	function testHash()
	{
		...
		$callables = array(
			...
			'globalFunction' => 'DataStructures\\doNothing',
			'staticArrayCallable' => array('DataStructures\\CallableStub', 'staticMethod'),
			'staticCallable' => 'DataStructures\\CallableStub::staticMethod',
		);
		...
		$expectedHashes = array(
			...
			'globalFunction' => 'DataStructures\\doNothing',
			'staticArrayCallable' => 'DataStructures\\CallableStub::staticMethod',
			'staticCallable' => 'DataStructures\\CallableStub::staticMethod',
		);
