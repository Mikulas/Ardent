...
class VectorTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * @covers \DataStructures\Vector::clear
	 */
	function testClear()
	{
	...
	/**
	 * @covers \DataStructures\Vector::any
	 */
	function testAny()
	{
		$any1 = function ($item) {
	...
	/**
	 * @covers \DataStructures\Vector::isEmpty
	 */
	...
	/**
	 * @covers \DataStructures\Vector::offsetExists
	 */
	...
	/**
	 * @covers \DataStructures\Vector::offsetGet
	 * @expectedException \DataStructures\Exception\IndexException
	 */
	...
	/**
	 * @covers \DataStructures\Vector::offsetGet
	 * @expectedException \DataStructures\Exception\TypeException
	 */
	...
	/**
	 * @covers \DataStructures\Vector::offsetSet
	 */
	...
	/**
	 * @covers \DataStructures\Vector::offsetUnset
	 * @covers \DataStructures\Vector::count
	 */
	...
	/**
	 * @covers \DataStructures\Vector::append
	 * @covers \DataStructures\Vector::count
	 */
	function testAppend()
	{
	...
	/**
	 * @covers \DataStructures\Vector::get
	 */
	function testGet()
	{
		$vector = new VectorMock;
	...
	/**
	 * @covers \DataStructures\Vector::set
	 */
	function testSet()
	{
		$vector = new VectorMock;
	...
	/**
	 * @covers \DataStructures\Vector::remove
	 */
	function testRemove()
	{
	...
	/**
	 * @covers \DataStructures\Vector::__construct
	 * @covers \DataStructures\Vector::removeItem
	 */
	...
	function testEverySome()
	{
		...
		$this->assertFalse($vector->every(function ($val) {
			return $val === null;
		}));
	}
	...
	function testEvery()
	{
		...
		$this->assertTrue($vector->every(function ($val) {
			return $val === null;
		}));
	}
	...
	function testLimit()
	{
		...
		$this->assertInstanceOf('DataStructures\\Vector', $limited);
	...
	{
		$vector = new Vector();
		$this->assertNull($vector->max(function () {
			return 1;
		}));
	}
	...
	{
		$vector = new Vector();
		$this->assertNull($vector->min(function () {
			return 1;
		}));
	}
	...
	function testMap()
	{
		...
		$this->assertInstanceOf('DataStructures\\Vector', $mapped);
	...
	function testSlice()
	{
		...
		$this->assertInstanceOf('DataStructures\\Vector', $slicer);
	...
	function testWhere()
	{
		...
		$this->assertInstanceOf('DataStructures\\Vector', $odd);
	...
	function testSkipNone()
	{
		...
		$b = $a->skip(0);
		$this->assertInstanceOf('DataStructures\\Vector', $b);
	...
	function testApply()
	{
		...
		$this->assertInstanceOf('DataStructures\\Vector', $vector);
	...
	function testIterator()
	{
		...
		$this->assertInstanceOf('\\DataStructures\\Iterator\\VectorIterator', $iterator);
