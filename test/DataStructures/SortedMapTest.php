...
use DataStructures\Iterator\InOrderIterator,
	DataStructures\Iterator\SortedMapIterator;
...
class SortedMapTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * @expectedException \DataStructures\Exception\KeyException
	 */
	...
	/**
	 * @expectedException \DataStructures\Exception\EmptyException
	 */
	...
	function testIterator()
	{
		...
		$this->assertInstanceOf('DataStructures\\Iterator\\SortedMapIterator', $iterator);
