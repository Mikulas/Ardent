...
class AbstractSetTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * @covers \DataStructures\AbstractSet::difference
	 */
	function testDifferenceNone()
	{
		...
		$diff = $a->difference($b);
		$this->assertInstanceOf('DataStructures\\HashSet', $diff);
	...
	/**
	 * @covers \DataStructures\AbstractSet::intersection
	 */
	function testIntersectionEmpty()
	{
		...
		$this->assertInstanceOf('DataStructures\\HashSet', $intersection);
	...
	/**
	 * @covers \DataStructures\AbstractSet::relativeComplement
	 */
	function testRelativeComplementSelf()
	{
		...
		$this->assertInstanceOf('DataStructures\\HashSet', $complement);
	...
	/**
	 * @covers \DataStructures\AbstractSet::union
	 */
	function testUnionSelf()
	{
		...
		$union = $a->union($a);
		$this->assertInstanceOf('DataStructures\\HashSet', $union);
		$this->count(3, $union);
